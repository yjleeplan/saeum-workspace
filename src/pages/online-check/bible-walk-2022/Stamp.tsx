...
import btn1 from 'assets/images/bible-walk-2022/btn_1.png';
import btn2 from 'assets/images/bible-walk-2022/btn_2.png';
import btn3 from 'assets/images/bible-walk-2022/btn_3.png';
import btn4 from 'assets/images/bible-walk-2022/btn_4.png';
import btn5 from 'assets/images/bible-walk-2022/btn_5.png';
import complete1 from 'assets/images/bible-walk-2022/btn_1_complete.png';
import complete2 from 'assets/images/bible-walk-2022/btn_2_complete.png';
import complete3 from 'assets/images/bible-walk-2022/btn_3_complete.png';
import complete4 from 'assets/images/bible-walk-2022/btn_4_complete.png';
import complete5 from 'assets/images/bible-walk-2022/btn_5_complete.png';
...
const Stamp = ({ index, attendanceYn, attendanceId, onSelectUser, setIsLoading, today, hour }: StampProps) => {
  ...
  const isUpdateEnable = () => {
    ...
    if (type && !['COMPLETE1', 'COMPLETE2', 'COMPLETE3', 'COMPLETE4', 'COMPLETE5'].includes(type)) {
      result = true;
    }
