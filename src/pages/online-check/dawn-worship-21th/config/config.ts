...
export const IS_NOT_COMPLETE = (index: number, today: number) => {
  switch (index) {
    case 0:
      return today === 23 ? 'DAY1' : 'SOON';
    case 1:
      return today === 24 ? 'DAY2' : 'SOON';
    case 2:
      return today === 25 ? 'DAY3' : 'SOON';
    case 3:
      return today === 26 ? 'DAY4' : 'SOON';
    case 4:
      return today === 27 ? 'DAY5' : 'SOON';
    case 5:
      return today === 28 ? 'DAY6' : 'SOON';
    case 6:
      return today === 2 ? 'DAY7' : 'SOON';
    case 7:
      return today === 3 ? 'DAY8' : 'SOON';
    case 8:
      return today === 4 ? 'DAY9' : 'SOON';
    case 9:
      return today === 5 ? 'DAY10' : 'SOON';
    case 10:
      return today === 6 ? 'DAY11' : 'SOON';
    case 11:
      return today === 7 ? 'DAY12' : 'SOON';
